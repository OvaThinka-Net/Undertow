...
type AppConfig struct {
	...
	// GoogleFolderName is the Drive folder name to find/create (default "Flow-Data").
	GoogleFolderName string `json:"google_folder_name,omitempty"`
...
func (c *AppConfig) FolderName() string {
	if c.GoogleFolderName != "" {
		return c.GoogleFolderName
	}
	return "Flow-Data"
}
